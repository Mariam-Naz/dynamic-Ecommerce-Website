                ...
                <div class="login-snip"> <input id="tab-1" type="radio" name="tab" class="sign-in" checked><label for="tab-1" class="tab">Login</label> <input id="tab-2" type="radio" name="tab" class="sign-up"><label for="tab-2" class="tab">Sign Up</label>
                    <div class="login-space">
                        ...
                        <form class="sign-up-form" method="POST">
                            ...
                            <div class="group"> <label for="pass" class="label">Mobile Number</label> <input id="pass" type="text" class="input" placeholder="Enter your mobile number"> </div>
                            <div class="group"> <label for="pass" class="label">Home Address</label> <input id="pass" type="text" class="input" placeholder="Enter your home address"> </div>
